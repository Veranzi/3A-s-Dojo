          ...
          <div className="card space-y-8">
            <div>
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                3A's Dojo is committed to protecting your privacy and ensuring compliance with the 
                <strong> Kenya Data Protection Act (2019)</strong>. This policy explains how we handle 
                data when you use our platform.
              </p>
              <p className="text-slate-700 leading-relaxed">
                <strong>Important:</strong> 3A's Dojo does not require registration, login, or collection 
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed mb-4">
                3A's Dojo is designed to comply with the Kenya Data Protection Act (2019) principles:
              </p>
            ...
            <div>
              ...
              <p className="text-slate-700 leading-relaxed">
                3A's Dojo is designed to be safe for users of all ages. Since we do not collect personal 
